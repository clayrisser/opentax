...
const fields: ReadonlyArray<PdfFieldEntry> = [
  { kind: "text", domainKey: "wages", pdfField: "topmostSubform[0].Page1[0].Pg1Table[0].Row2[0].f1_8[0]" },
  { kind: "text", domainKey: "prior_ss_wages", pdfField: "topmostSubform[0].Page1[0].Pg1Table[0].Row2[0].f1_11[0]" },
];
